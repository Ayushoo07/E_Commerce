...
public class CartController {
    ...
    public ResponseEntity addToCart(@RequestBody ItemRequestDto itemRequestDto) throws Exception {
        ...
        try{
            Item savedItem = itemServiceImpl.addItem(itemRequestDto);
            CartResponseDto cartResponseDto = cartServiceImpl.saveCart(itemRequestDto.getCustomerId(),savedItem);
    ...
    public OrderResponseDto checkOutCart(@RequestBody CheckoutCartRequestDto checkoutCartRequestDto) throws Exception {
        ...
        return cartServiceImpl.checkOutCart(checkoutCartRequestDto);
    }
}